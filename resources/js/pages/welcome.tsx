                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-center shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <h1 className="mb-4 text-3xl font-light text-black">Minimalist Tasks</h1>
                            <p className="mb-8 text-lg text-gray-600">A clean, simple way to manage your to-do list</p>
                            
                            {!auth.user && (
                                <div className="space-y-4">
                                    <p className="text-sm text-gray-500 mb-6">Sign in to start organizing your tasks</p>
                                    <div className="flex gap-4 justify-center">
                                        ...
                                        <Link
                                            href={route('register')}
                                            className="border border-black text-black px-6 py-2 rounded-sm hover:bg-gray-50 transition-colors"
                                        >
                                            Register
                                        </Link>
                                    </div>
